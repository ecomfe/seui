/**
 * @file TranslateHandlerHandler for drag a component(参考veui)
...
export default class TranslateHandler extends BaseHandler {
    ...
    reset() {
        ...
        this.elms.forEach(elm => {
            let initialTransform = getComputedTransform(elm);
            let transformStyle = initialTransform === 'none'
                ? ''
                : initialTransform + ` translate(${-this.totalDistanceX}px,${-this.totalDistanceY}px)`;
